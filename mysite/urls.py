...
urlpatterns = [
    ...
    path(
        "deletecompany/<int:company_id>/", views.delete_company, name="delete_company"
    ),
    # # Vehicle crud URLs
    ...
    path(
        "deletevehicle/<int:vehicle_id>/", views.delete_vehicle, name="delete_vehicle"
    ),
